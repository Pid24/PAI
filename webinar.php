      ...
      <div class="container">
        <div class="row">
          ...
          <?php foreach($web as $row) : ?>
            <div class="webinar1">
              <img src="img/<?= $row["gambar"]; ?>" alt="banner1" width="400" height="400" />
              <h2><?= $row["judul"]; ?></h2>
              <p><?= $row["deskripsi"]; ?>⁣</p>
              <a href="webinars.php" type="button" class="btn btn-success">Baca selengkapnya</a>
            </div>
            <?php endforeach; ?>
          </div>
        </div>
