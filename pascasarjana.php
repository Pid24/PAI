...
$kmps = query("SELECT * FROM info_pasca"); 
$sop = query("SELECT * FROM sop_pasca"); 
?>
  ...
  <body>
    ...
    <section id="isi">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6">
            <h2 class="mb-5">Informasi Pasca Sarjana</h2>
            <ul class="ul1">
              <?php foreach($kmps as $row) : ?>
              <li><p><?= $row["pasca_info"]; ?></p></li>
              <?php endforeach; ?>
            </ul>
          </div>
        </div>
    ...
    <section id="isi">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6">
            <h2 class="mb-5">SOP Perkuliahan Pasca Sarjana</h2>
            <ul class="ul2">
              <?php foreach($sop as $row) : ?>
              <li><p><?= $row["info_sop"]; ?></p></li>
              <?php endforeach; ?>
            </ul>
          </div>
        </div>
